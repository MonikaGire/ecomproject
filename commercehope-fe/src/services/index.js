...
export const about = async (payload) => {
  const { data } = await http.post(`/about`, payload);
  return data;
};
export const blog = async (payload) => {
  const { data } = await http.post(`/blog`, payload);
  return data;
};
...
// materials
export const getMaterials = async (page, search) => {
  const { data } = await http.get(`/admin/materials?search=${search}&page=${page}`);
  return data;
};
export const getMaterialByAdmin = async (id) => {
  const { data } = await http.get(`/admin/materials/${id}`);
  return data;
};
export const getAllMaterials = async () => {
  const { data } = await http.get(`/admin/all-materials`);
  return data;
};

export const addMaterial = async (payload) => {
  const { data } = await http.post(`/admin/materials`, payload);
  return data;
};
export const updateMaterial = async ({ currentSlug, ...payload }) => {
  const { data } = await http.put(`/admin/materials/${currentSlug}`, payload);
  return data;
};
export const deleteMaterial = async (slug) => {
  const { data } = await http.delete(`/admin/materials/${slug}`);
  return data;
};
// categories
